...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/02 00:58:03 by ashih             #+#    #+#             */
/*   Updated: 2018/02/08 06:07:20 by ashih            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		store_diter(double *diter, int i, t_cnum *z, t_fractal *f)
{
	if (i == f->max_iter)
		*diter = (double)(i - 1);
	else
		*diter = (double)i - log((log(z->real * z->real + z->imag * z->imag)
		/ 2.0) / log(2.0)) / log(2.0);
}
